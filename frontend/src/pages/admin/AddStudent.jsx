  ...
  const handleSubmit = async (e) => {
    ...
    await withLoading(async () => {
      try {
        ...
        // Add student information as 'label'
        formData.append('label', values.roll_no);
        ...
        toast.success(response.data.message || 'Student data uploaded successfully!');
        
        if (response.data.training_completed) {
          toast.success('Training completed automatically!');
        } else if (response.data.training_error) {
          toast.error(`Training failed: ${response.data.training_error}`);
        }
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="card">
          ...
          <div className="mt-4 text-sm text-gray-500">
            <p>• Upload clear photos or a short video of the student.</p>
            <p>• For videos, ensure the student's face is visible for a few seconds.</p>
