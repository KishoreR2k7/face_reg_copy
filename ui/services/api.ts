...
export const BASE_URL = 'http://127.0.0.1:5000'; // Your Flask backend URL
...
export const addCamera = async (name: string, ip_address: string): Promise<{ message: string; camera_id: number }> => {
    const response = await fetch(`${BASE_URL}/cameras`, {
        method: 'POST',
        headers: getAuthHeaders(),
